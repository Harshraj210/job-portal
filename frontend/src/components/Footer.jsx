        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Connecting talent with opportunity. The easiest way to find your
              next dream job or perfect candidate.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li>
                <Link
                  to="/jobs"
                  className="hover:text-[#7315c7] transition-colors"
                >
                  Browse Jobs
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              <li>
                <Link
                  to="/about"
                  className="hover:text-[#7315c7] transition-colors font-medium"
                >
                  About Us
                </Link>
              </li>
