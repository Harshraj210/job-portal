    ...
    <div className="min-h-screen w-full bg-gray-50 px-6 py-20 flex justify-center">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-md">
        ...
        <p className="text-gray-600 mb-8">
          Welcome back,{" "}
          <span className="font-bold text-blue-600">{user?.name}</span>! Manage
          your job postings and applications here.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Link to="/recruiter-dashboard/manage-jobs">
            <div className="p-6 bg-purple-50 rounded-lg border border-purple-100 hover:shadow-lg transition-shadow cursor-pointer">
